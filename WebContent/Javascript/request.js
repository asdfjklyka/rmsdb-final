    ...
    return {
        ...
        init: function () {
            ...
            function editRow(oTable, nRow) {
                ...
                var jqTds = $('>td', nRow);
                // forrequest = aData[0];
                befreqname = aData[0]; //name
                befreqquan = aData[1]; //quantity
                befrequnit = aData[2]; //description
                befreqsup = aData[3]; //property no
                befreqamt = aData[4]; //amount
                ...
                jqTds[5].innerHTML = '<input type="number" class="form-control small" value="' + aData[5] + '" style="width:100%; color:black;" >'; //QTY UNITS
                jqTds[6].innerHTML = "<center><a class='btn btn-success edit' href='javascript:;'><i class='fa fa-save '></i></a> <a class='btn btn-danger cancel' href='javascript:;'><i class='fa fa-ban'></i></a></center>";
            ...
            function saveRow(oTable, nRow) {
                ...
                oTable.fnUpdate("<center><a class='btn btn-primary  edit' href='javascript:;'><i class='fa fa-edit'></i></a> </center>", nRow, 5, false);
                oTable.fnDraw();
            }
            ...
            function saveEdit(oTable, nRow) {
                ...
                oTable.fnUpdate(jqInputs[3].value, nRow, 3, false); //UNIT
                oTable.fnUpdate(jqInputs[4].value, nRow, 4, false); //DESCRIPTION
                oTable.fnUpdate("<center><a class='btn btn-primary  edit' href='javascript:;'><i class='fa fa-edit'></i></a> <a class='btn btn-danger delete' href='javascript:;''><i class='fa fa-trash-o'></i> </center>", nRow, 5, false);
                oTable.fnDraw();
            }
            ...
            function cancelEditRow(oTable, nRow) {
                ...
                oTable.fnUpdate(jqInputs[3].value, nRow, 3, false); //UNIT
                oTable.fnUpdate(jqInputs[4].value, nRow, 4, false); //DESCRIPTION
                oTable.fnUpdate('<a class="btn btn-success edit" href="">Edit</a>', nRow, 5, false);
                oTable.fnDraw();
            }
            ...
            $('#btnmodaladd').live('click', function (e) {
                ...
                else
                {
                    ...
                    var aiNew = oTable.fnAddData([name,quan, unit, sup,price, "<center><a class='btn btn-primary edit' href='javascript:;'><i class='fa fa-edit'></i></a> <a class='btn btn-danger delete' href='javascript:;''><i class='fa fa-trash-o'></i></a> </center>"]);
